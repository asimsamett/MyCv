    ...
    public sealed class UpdateClientCommandValidator : AbstractValidator<UpdateClientCommand>
    {
        public UpdateClientCommandValidator()
        {
            ...
            RuleFor(x => x.Surname)
                ...
                .MaximumLength(123).WithMessage("En fazla 120 karakter olmalı."); // Soyisim en fazla 123 karakter uzunluğunda olabilir. (Düzeltme: Hata mesajında 120 karakter sınırı yerine 123 karakter sınırlı.)
            ...
            // ClientFeatures alanı için validasyon kuralları
            RuleFor(x => x.UpdateClientFeatures)
                .NotNull().WithMessage("ClientFeature boş olamaz."); // `UpdateClientFeatures` boş olamaz.

            // `UpdateClientFeatures` alanı boş değilse ek validasyon kuralları
